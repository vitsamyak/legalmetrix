...
const AIProcessing = lazy(() => import('./pages/AIProcessing').then(m => ({ default: m.AIProcessing })));
          ...
          <Suspense fallback={<BrandedLoader fullScreen={true} message="LegalMetrix AI" subMessage="Loading application modules..." />}>
            <Routes>
              ...
              >
                ...
                <Route path="/dashboard/process" element={<AIProcessing />} />
                ...
                <Route path="/dashboard/evidence" element={<EvidenceReview />} />
